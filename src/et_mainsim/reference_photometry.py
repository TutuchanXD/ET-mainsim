...
def _normalize_formal_provenance_series_caller(caller: dict[str, Any]) -> None:
    ...
    # The delivery provenance audit defines source code identity as Git commit
    # plus clean/dirty state.  Roots, branches, package versions, and runtime
    # host/executable records are execution disclosure, not scientific state.
